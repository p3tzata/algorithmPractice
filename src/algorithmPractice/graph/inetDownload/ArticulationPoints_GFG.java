...
;	        for (int i = 0; i < V; i++) 
	    ...
	    { 
	       ...
	       // System.out.println(); 
	        ...
	        ArticulationPoints_GFG g2 = new ArticulationPoints_GFG(3); 
	        g2.addEdge(0, 1); 
	        g2.addEdge(1, 2); 
	       // g2.addEdge(2, 3); 
	       // g2.AP(); 
	       // System.out.println(); 
	        ...
	        ArticulationPoints_GFG g3 = new ArticulationPoints_GFG(7); 
	        g3.addEdge(0, 1); 
	        g3.addEdge(1, 2); 
	        g3.addEdge(2, 0); 
	        g3.addEdge(1, 3); 
